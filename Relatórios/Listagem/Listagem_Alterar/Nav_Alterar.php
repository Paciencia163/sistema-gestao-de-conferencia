            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="dropdown-item" href="../../Relatorio_de_venda_por_Cliente/Relatorio.php">Relatório de venda</a>
                        <a class="dropdown-item" href="../../Relatorio_de_Filmes_ja_apresentados/Relatorio.php">Relatório de conferencia já apresentados</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="../navbarDropdown">
                            <a class="dropdown-item" href="../../Listagem/Filmes_Cadastrados.php">Conferência</a>
