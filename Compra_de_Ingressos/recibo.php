    ...
    <div class="container" style="padding-top:100px">
        ...
        <div class="card bg-light">
            <div class="card-body">
                ...
                <center>
                    <h2 class="card-title">ISPH Conferência</h2>
               </center>
                ...
                <div style="padding-left:15px">
                   <?php date_default_timezone_set('America/Sao_Paulo'); ?>
                    ...
                    <p><i class="fas fa-map-marker-alt"></i> Local: Arimba - Instituto Politecnico da Huila</p>
                    <br>
                    <h4><?= "Conferência: "  . $linha_filme['nome'] ?></h3>
                        <br><br>
                </div>
                <center>
                    ----------------------------------------------------------------------------------------------------------------------------------------------- </p>
